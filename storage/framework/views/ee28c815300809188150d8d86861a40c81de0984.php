...
<head>
    ...
    <link href="<?php echo e(asset('assets/css/variables.css')); ?>" rel="stylesheet">
...
<body>
  <!-- ======= Header ======= -->
    <header id="header" class="header fixed-top" data-scrollto-offset="0">
        ...
        <a href="<?php echo e(url('/')); ?>" class="logo d-flex align-items-center scrollto me-auto me-lg-0">
        ...
        <nav id="navbar" class="navbar">
            ...
            <li><a class="nav-link scrollto" href="<?php echo e(url('/#about')); ?>">Nosotros</a></li>
            <li><a class="nav-link scrollto" href="<?php echo e(url('/#services')); ?>">Servicios</a></li>
            <li><a class="nav-link scrollto" href="<?php echo e(url('/#contact')); ?>">Contacto</a></li>
            </ul>
            <i class="bi bi-list mobile-nav-toggle d-none"></i>
        </nav><!-- .navbar -->

        <a class="btn-getstarted scrollto" href="<?php echo e(url('/proyectos')); ?>">Proyectos</a>
    ...
    <footer id="footer" class="footer">
        ...
        <div class="container">
            ...
            <div class="col-lg-2 col-md-6 footer-links">
                ...
                <li><i class="bi bi-chevron-right"></i> <a href="<?php echo e(asset('storage/aviso_privacidad.pdf')); ?>" target="_blank">Aviso de Privacidad</a></li>
                </ul>
            </div>
...
<?php /**PATH C:\Users\jorge.romero\Documents\laragon\www\websigevo\resources\views/layouts/simple.blade.php ENDPATH**/ ?>