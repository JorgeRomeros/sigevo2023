...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Completa la informacion del <font color="#0d6efd"> Informe Semanal</font>: {{$titulo}}</h1>
        </div>
    </div>
</div>
<div class="content">
    <div class="block block-rounded">
        <div class="block-content">
            ...
            <div class="row">
                ...
                <a type="button" class="btn btn-lg btn-outline-primary" href="{{ url('/semanal') }}">
                    ...
                    <form wire:submit.prevent="updateWeeklyReport" class="form-control" class="row row-cols-lg-auto g-3 align-items-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="block block-rounded">
                                    <div class="block-content">
                                        <x-form-input label="recibe"  name="recibe" titulo/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4">
