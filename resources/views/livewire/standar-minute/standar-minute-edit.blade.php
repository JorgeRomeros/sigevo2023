...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Actualiza la informacion del la Minuta: {{$folio}}</h1>
        </div>
    </div>
</div>
<div class="content">
        ...
        <div class="block-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 space-y-2">
                    ...
                    <form wire:submit.prevent="updateStandarMinute" class="form-control" class="row row-cols-lg-auto g-3 align-items-center">
                        @wire
                        <div class="row">
