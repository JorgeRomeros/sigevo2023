    ...
    <div class="modal @if ($showModal) show @endif" @if ($showModal) style="display:block; overflow-y:auto;" @endif id="modal-block-normal" tabindex="-1" role="dialog" aria-labelledby="modal-block-normal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <x-form wire:submit.prevent="addMonthlyReport">
                    <div class="block block-rounded block-themed block-transparent mb-0">
                        <div class="block-header bg-primary-dark">
                            <h3 class="block-title">Nuevo Informe Semanal</h3>
                        ...
                        <div class="block-content pb-3">
                            ...
                            <div class="form-row">
                                <div class="col-lg-12">
                                    <x-form-input name="elabora" label="elabora" required />
                                </div>
                                <div class="col-lg-12">
                                    <x-form-input name="recibe" label="recibe"  />
                                </div>
                                <div class="col-lg-12">
